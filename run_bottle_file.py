...
# hakai.get_site_netcdf_files('QU5', get_hakai_bottle_processing_list())
#hakai.get_site_netcdf_files('QU39', get_hakai_bottle_processing_list())
# hakai.get_site_netcdf_files('DFO2', get_hakai_bottle_processing_list())
hakai.get_site_netcdf_files('FZH01', get_hakai_bottle_processing_list())
#hakai.get_site_netcdf_files('KC10', get_hakai_bottle_processing_list())
#hakai.get_site_netcdf_files('QU43', get_hakai_bottle_processing_list())
#hakai.get_site_netcdf_files('QCS01', get_hakai_bottle_processing_list())
#hakai.get_site_netcdf_files('ROCKY06', get_hakai_bottle_processing_list())
